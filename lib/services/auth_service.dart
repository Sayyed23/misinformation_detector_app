  ...
  Future<AuthResponse?> signInAsGuest() async {
    try {
      ...
      try {
        ...
        debugPrint('Anonymous auth not available: $anonymousError');
      }
      ...
      try {
        ...
        if (signUpResponse.session != null) {
          ...
          final loginResponse = await _client.auth
              .signInWithPassword(email: guestEmail, password: guestPassword);
          return loginResponse;
        } else {
          throw 'Failed to create guest user';
        }
      } catch (e) {
        debugPrint('Guest signup error details: $e');
